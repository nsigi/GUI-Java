...
public class TabulatedFunctionFrame extends JFrame {
    ...
    private void onDel3(){
        try{
            ...
            JOptionPane.showMessageDialog(this, e.getMessage(), "Ошибка удаления 3 точки!", JOptionPane.ERROR_MESSAGE);
        } catch (IllegalStateException e) {
            JOptionPane.showMessageDialog(this, "Невозможно удалить точки, когда их меньше 2", "Ошибка удаления 3 точки!!", JOptionPane.ERROR_MESSAGE);
        } catch (ArrayIndexOutOfBoundsException e) {
            JOptionPane.showMessageDialog(this, "Выбрали точку с неверным индексом", "Ошибка удаления 3 точки!!", JOptionPane.ERROR_MESSAGE);
        }
    }
